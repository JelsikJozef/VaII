<?php
// AI-GENERATED: Manual edit form view (GitHub Copilot / ChatGPT), 2026-01-18
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="h4 mb-0">Edit Article</h1>
                <a href="<?= $link->url('Manual.show', ['id' => $id]) ?>" class="btn btn-outline-secondary">Back</a>
            </div>

            <form method="post" action="<?= $link->url('Manual.update', ['id' => $id]) ?>" novalidate>
                ...
                <a href="<?= $link->url('Manual.show', ['id' => $id]) ?>" class="btn btn-secondary ms-2">Cancel</a>
            </form>
        </div>
    </div>
</div>
